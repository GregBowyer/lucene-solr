...
/**
 * Intrinsic varient of the Lucene 5.0 postings format, which encodes postings in packed integer blocks
 * for fast decode. In this case replacing Frame-Of-Reference (FOR) codes with that of MaskedVBytes as described
 * in:
 *
 ...
 *
 * The core algorithm remains near identical to that of Lucene50PostingsFormat with the FOR codes being replaced
 *
 * <strong>Note:</strong> This is experiemental and requires both a native library as well as a fairly modern X86 cpu
 * supporting SSE / AVX and similar SIMD vectorisation capabilities.
 *
 * <p>
 * Basic idea:
 * <ul>
...
public final class IntrinsicsPostingsFormat extends PostingsFormat {
  /**
  ...
  public IntrinsicsPostingsFormat(int minTermBlockSize, int maxTermBlockSize) {
    super("IntrinsicLucene50");
  ...
  public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
    PostingsWriterBase postingsWriter = new IntrinsicsPostingsWriter(state);
  ...
  public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
    PostingsReaderBase postingsReader = new IntrinsicsPostingsReader(state);
    boolean success = false;
    try {
